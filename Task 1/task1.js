...
//   const genArray = ['11','21','31','41','51','52','53','54','55'];  // this will be generated by blocky
//   var len = genArray.length;
//   for(var i=1;i<len;i++){
//     $('#'+genArray[i-1]).addClass('hide');
//     $('#'+genArray[i]).removeClass('hide');
//     if(genArray[i]=='55' && i==len-1){   // if the user wins
//       $('#goal').addClass('hide');
//       isWon = true;
//       break;
//     }
